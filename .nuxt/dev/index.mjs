...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/user/Desktop/gns/gns-front/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/Users/user/Desktop/gns/gns-front/node_modules/ufo/dist/index.mjs';
...
import { consola } from 'file://C:/Users/user/Desktop/gns/gns-front/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/user/Desktop/gns/gns-front/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/user/Desktop/gns/gns-front/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://C:/Users/user/Desktop/gns/gns-front/node_modules/vue/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\user\\Desktop\\gns\\gns-front\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ldcmfs10lL = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/user/Desktop/gns/gns-front";
...
const _lazy_furufZ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_furufZ, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file://C:/Users/user/Desktop/gns/gns-front/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
